...
def download_file():
    ...
    # 假设我们要写入的数据包含以下字段
    fields = ['skuid', 'url', 'Imageurl', 'root', 'brand', 'brandId', 'siteBrandId', 'name', 'supplier', 'supplierId',\
               'supplierRating', 'priceU', 'salePriceU', 'sale', 'logisticsCost', 'returnCost', 'pics','rating','reviewRating',\
                'feedbacks', 'adcpm', 'adpromotion', 'adpromoPosition', 'adposition', 'adadvertId', 'devileveyDay', \
                    'search_text', 'searchTime', 'pageRank', 'page', 'rank']  # 替换为实际字段名
